...
export default function Menu() {
  ...
  const renderMenuGroup = (items) => {
    ...
    const aspect19_6Images = ['G1', 'G2', 'G3', 'G4']; 
    ...
    const is19_6Aspect = aspect19_6Images.includes(imageCode); 
    ...
    if (is19_6Aspect) {
        // FIX: Switching to 16:7 for a wider, cinematic "wallpaper" look (2.28:1 ratio).
        placeholderDimensions = '640x280'; // 16:7 aspect ratio
